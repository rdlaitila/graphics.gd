...
// `GDNEXT_PLAY_REPORT:<base64>` console line, writes the decoded
...
const reportPrefix = "GDNEXT_PLAY_REPORT:";
...
const timeoutPromise = new Promise((_, reject) =>
	setTimeout(() => reject(new Error(`timeout: no GDNEXT_PLAY_REPORT within ${timeoutMs}ms`)), timeoutMs)
);
